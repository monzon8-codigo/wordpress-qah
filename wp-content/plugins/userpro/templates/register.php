<div id="div-registro" class="userpro userpro-<?php echo $i; ?> userpro-<?php echo $layout; ?>" <?php userpro_args_to_data( $args ); ?>>
	...
	<div class="userpro-body">
		...
		<form action="" method="post" data-action="<?php echo $template; ?>">
			...
			<div class="userpro-field userpro-submit userpro-column">
				...
				<input type="submit" value="Unirme!" class="userpro-button" />
				<!--<?php echo $args["{$template}_button_primary"]; ?>-->
				<?php } ?>
				
				<?php if ($args["{$template}_button_secondary"]) { ?>
				<span class="conecta-con" style="margin:0px 0px 0px 47px !important;font-weight:500;font-size:15px;">Tambien puedes unirte a traves de:</span>

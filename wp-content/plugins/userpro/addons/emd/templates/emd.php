...
<div class="emd-main emd-main-<?php echo $emd_state; ?>">
	...
	<div class="emd-list" data-layoutmode="<?php echo $args['emd_layout']; ?>" style="text-align:center">
		...
		$user_id = $user->ID; 
		$cargo=userpro_profile_data('cargo',$user_id);
		if ($cargo!=$cargo_aux){
					echo '<div id="cargo'.$cargo.'" class="userpro-clear"></div><img src="'.get_bloginfo('template_url').'/images/cargo'.$cargo.'.jpg">';
					$cargo_aux=$cargo;
		}
		...
		<div class="emd-user" style="min-height:370px; display:inline-block;float:none;margin-bottom:0px !important; padding-top:20px !important;">
			...
			<?php $userpro_emd->print_field( 'cargo', $user_id );  ?>

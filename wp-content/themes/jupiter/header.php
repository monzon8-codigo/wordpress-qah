...
<?php /* Header right section elements */ ?>
  <div class="mk-header-right" style="z-index:30; color:white; top:7px; height:60px;">
  <ul style="display:inline; list-style:none">
  <li class="num-articulos" style="float:left; padding:0 12px;line-height:30px; margin-top:30px; margin-left: 0 !important; font-weight:bold;">+10.000 ARTICULOS</li> 
	<a href="http://monzon8.es/wordpress-qah/suscribete-qah/"><li style="background:#05486F; color:#FFF; float:left; padding:0 12px; margin-left: 0 !important; line-height:30px; margin-top:30px; font-weight:bold;"> &gt; SUSCRIBETE</li></a>
	<li class="num-redactores" style="float:left; padding:0 12px;line-height:30px; margin-top:30px; margin-left: 0 !important; font-weight:bold;">+2.500 REDACTORES</li>
	<li style="background:#009CE0; color:#FFF; float:left; padding:0 12px; margin-left: 0 !important; line-height:30px; margin-top:30px;"><a href="http://monzon8.es/wordpress-qah/unete-equipo/" style="text-decoration:none; font-weight:bold; color:white;"> &gt; ÚNETE</a></li>
	<li style="float:left; padding:0 12px;line-height:30px; margin-top:30px; margin-left: 0 !important; font-weight:bold;">|</li>
	<li style="float:left; line-height:20px; margin-top:20px; margin-left: 0 !important;"><a href="https://www.facebook.com/QueAprendemosHoycom" target="_blank"><img src="http://monzon8.es/wordpress-qah/wp-content/uploads/2015/05/facebook.png" alt="Facebook"></a></li>
	<li style="float:left; line-height:20px; margin-top:20px; margin-left: 0 !important;"><a href="https://twitter.com/qahcom" target="_blank"><img src="http://monzon8.es/wordpress-qah/wp-content/uploads/2015/05/twitter.png" alt="Twitter"></a></li>
	<li style="float:left; line-height:20px; margin-top:20px; margin-left: 0 !important;"><a href="https://es.linkedin.com/company/qu-aprendemos-hoy" target="_blank"><img src="http://monzon8.es/wordpress-qah/wp-content/uploads/2015/05/linkedin.png" alt="LinkedIn"></a></li>
	<li style="float:left; line-height:20px; margin-top:20px; margin-left: 0 !important;"><a href="https://plus.google.com/+Queaprendemoshoycom/posts" target="_blank"><img src="http://monzon8.es/wordpress-qah/wp-content/uploads/2015/05/googleplus.png" alt="Google +"></a></li>
	</ul>
  <?php 
